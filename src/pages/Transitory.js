      ...
      <div className="flex flex-col sm:flex-row sm:space-x-16 items-start justify-start space-y-4 sm:space-y-0 w-full h-full">
            ...
            <div class="flex flex-row w-full h-full items-start justify-center space-x-2">
              <div class="relative flex w-full items-center justify-start">
                <div class={`absolute inset-0 animate-flip-down`}>
                  <div class={`absolute inset-0 duration-[2000ms]`}>
                    ...
                    <div class="flex w-1/2">
                        ...
                        <svg class="w-full h-full text-cowjuice-black text-cowjuice-black z-20" id="Layer_2" data-name="Layer 2" viewBox="0 0 119.06 300.64">
                ...
                <div class="flex w-full h-full items-center justify-center animate-fade animate-delay[250ms]">
                  <img src={mockup_1a} alt="Cow Juice Mockup" className={`flex w-full opacity-0 transition-opacity duration-[2000ms] rounded-sm select-none`} />
                </div>
                    ...
                    <Typewriter
                      ...
                      onInit={(typewriter) => {
                        typewriter
                          ...
                          .pauseFor(500)
                          .typeString("The world's first can of <span class='uppercase font-bold bg-cowjuice-red rounded-sm px-[2px] text-white'>Ultra-Retorted Milk™</span>.<sup>[i]</sup>")
                          .callFunction(() => {
            ...
            {typingComplete && (
                <div class="flex flex-1 flex-col w-full h-full space-y-2 items-start justify-end">
                    <div class="flex border-t-[0.5px] border-black w-full animate-fade animate-delay-300"></div>
                    <p class="text-xs font-mono animate-flip-down animate-delay-300"><sup>[I]</sup> Production 2025-05-15. Distribution to immediately follow.</p>
                </div>
            )}
            </div>
          </div>
