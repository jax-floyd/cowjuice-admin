      ...
      <div className="flex flex-col sm:flex-row sm:space-x-16 items-start justify-start space-y-4 sm:space-y-0 -mt-16 w-full h-full">
            ...
            {typingComplete && (
                <div class="flex flex-1 flex-col w-full h-full space-y-2 items-start justify-end">
                    ...
                    <p class="text-[10px] uppercase sm:text-xs font-mono leading-3 sm:leading-normal animate-flip-up animate-delay-[250ms]"><sup>[I]</sup> Production completed 2025-05-15. Beta release to immediately follow.</p>
                </div>
            )}
            </div>
          </div>
