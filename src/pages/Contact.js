    ...
    return (
        <div className="inset-0 flex flex-col flex-1 min-h-screen max-w-3xl mx-auto px-6 pb-6 pt-24 w-full h-full items-center justify-between overflow-hidden">
            <div className="flex flex-col items-center justify-start space-y-4 w-full animate-fade">
                <p className="font-mono text-xs uppercase text-left w-full animate-flip-down animate-delay-[125ms]">
                ...
                <p className="font-mono text-xs uppercase text-left w-full animate-flip-down animate-delay-[250ms]">
                ...
                <p className="font-mono text-xs uppercase text-left w-full animate-flip-down animate-delay-[375ms]">
                ...
                <p className="font-mono text-xs uppercase text-left w-full animate-flip-down animate-delay-[500ms]">
            ...
            <div class="flex w-full flex-1 flex-col max-w-3xl items-center justify-end space-y-2 py-2">
                <div class="flex flex-col w-full items-center justify-center space-y-2 py-2 border-t-[0.5px] border-black animate-fade animate-delay-75">
                    <p class="text-xs uppercase font-mono text-left w-full inline animate-flip-up animate-delay-75"><sup>[1]</sup> All jokes aside, we'd love to hear from you.</p>
                    <button 
