...
import buy_the_juice from '../../assets/buy_the_juice.svg';
                    ...
                    {products.length > 0 && (
                        <div className="flex flex-col flex-1 w-full h-full border-[0.0px] sm:border-[0.5px] border-black rounded-sm items-start justify-between space-y-2 p-0 sm:p-4 animate-flip-down sm:animate-fade-left">
                            <div className="flex flex-1 flex-col items-start w-full space-y-2 uppercase">
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[125ms]">
                                    <sup>[1]</sup> It's the exact same Cow Juice in different size packs. You'll spend a lifetime deciding and a split second chugging. This is known to philosophers as the paradox of Cow Juicean choice.
                                </p>
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[250ms]">
                                    <sup>[2]</sup> Shipping takes 2–4 business days, unless of course your postman stops for extra ch**se.
                                </p>
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[375ms]">
                                    <sup>[3]</sup> All juiced cows are consenting adults (obviously since baby cows don't produce juice) and have signed waiver forms following an unimaginably ambiguous court-ordered consent decree. Cow Juice Inc. will tolerate no barnyard lawsuits of any kind, ever.
                                </p>
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[500ms]">
                                ...
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[625ms]">
                                ...
                                <p className="text-[10px] sm:text-[10px] leading-3 font-mono text-left w-full inline border-[0.5px] border-transparent hover:bg-neutral-100 hover:border-black transition-colors duration-300 cursor-default rounded-md p-1 animate-flip-down animate-delay-[750ms]">
                                    <sup>[6]</sup> There are no bags on this website - yet. While we're in Beta, you can buy one and only case of Cow Juice. We're sorry if this disappoints you and offer these and only these cases of Cow Juice as consulation.
                                </p>
                            </div>
