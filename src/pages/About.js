      ...
      <div className="flex flex-col items-center justify-start space-y-4 w-full animate-fade">
        ...
        <div class="flex flex-1 w-full">
          <div className="w-full flex-col items-center justify-center space-y-4 font-mono text-xs uppercase rounded-sm border-[0.5px] border-black dark:bg-white dark:border-white dark:text-black animate-fade-up animate-delay-[4600ms] animate-duration-[1500ms] p-2">
            ...
            <p class="animate-flip-down animate-delay-[5000ms]">In a breakthrough designed to confuse lactose-lunatics, refrigerators, and taste buds alike, Cow Juice Inc. ("Cow Juice") today announced the release of ultra-retorted milk.</p>
            <p class="animate-flip-down animate-delay-[5125ms]">As Founder, Cow Juice Man, explained on <a href="https://www.tiktok.com/@juiceofacow/video/7501106269315403054" target="_blank" rel="noopener noreferrer" class="bg-white text-cowjuice-red border-[0.5px] border-cowjuice-red font-bold rounded-sm px-[2px] animate-pulse">the TikTok</a>, ultra-retorted milk is pasteurized under ultra-retort pasteurization, a scientific process more commonly known as <span class='bg-cowjuice-red text-white uppercase rounded-sm px-[2px] font-bold'>retortation™</span>.</p>
            <div class="flex w-full border-b-[0.5px] border-black animate-fade animate-delay-[5250ms]" />
            <p class="animate-flip-down font animate-delay-[5375ms]">Retortation — the high-heat pasteurization which turns normal milk into a naturally sweeter, slightly-caramelized shelf-stable can of lactose-free cow juice - offers milk-lovers three (3) benefits which promise to usher in a new era of milk:</p>
            <ul className="w-full grid grid-cols-2 gap-1 text-[11px]">
              ...
              <li class="animate-fade-down animate-delay-[5500ms]">✔ Freedom from lactose — and the toilet, allowing for near-infinite cow juice consumption</li>
