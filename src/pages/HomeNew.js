...
import AmericanFlag from '../components/icons/AmericanFlag.js';
...
const HomeNew = () => {
    ...
    return (
      <div className="inset-0 flex flex-1 flex-col min-h-screen max-w-6xl mx-auto px-6 pb-6 pt-24 w-full h-full overflow-hidden">
        <div className="flex flex-1 flex-col sm:flex-row sm:space-x-16 items-start justify-start space-y-4 sm:space-y-0 w-full">
                ...
                {typingComplete && (
                  <>
                    <div class="flex flex-col items-center justify-center w-full space-y-2">
                      <img src={rack_2} class="hidden sm:block border-[0.5px] border-black rounded-sm animate-fade-left animate-delay-[200ms]"/>
                      <button
                        onClick={() => window.location.href = '/shopify/products'} 
                        class="flex w-full p-2 sm:p-4 rounded-sm bg-black text-white hover:bg-neutral-700 border-[0.5px] border-black animate-flip-up transition-colors duration-500"
                      >
