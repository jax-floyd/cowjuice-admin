...
const CowJuice = () => {
    ...
    return (
        <>
            ...
            <div ref={cowjuiceRef} className={anim("inset-0 bg-cowjuice-gold/10 relative z-20 flex flex-1 flex-row items-start justify-center h-screen pt-12 px-6 pb-6 w-full border-b-[0.5px] border-black overflow-hidden transition-all duration-1000")}>
                <div className="flex flex-1  flex-col items-start justify-between max-w-6xl mx-auto w-full h-full space-y-16">
                    <div class="flex w-full flex-1 h-full justify-between items-between flex-col space-y-4 pb-36">
                        <div className="flex relative w-full">
                            ...
                            <svg class="hidden sm:flex w-full sm:w-3/4" id="Layer_2" data-name="Layer 2" viewBox="0 0 337.48 132.34">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <g>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[0ms] sm:animate-delay-[0ms]")} d="M10.05,87.12c1.6,18.33,7.06,21.58,26.87,20.01l2.18,24.89c-25.7,2.08-34.01-4.98-38.18-52.57C-3.03,34.22,5.49,24.83,31.02,22.43l3.63,41.52c-22.91,2.17-26.18,5.17-24.6,23.16Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[30ms] sm:animate-delay-[30ms]")} d="M68.94,126.53c-19.54,1.71-23.72-12.84-28.01-61.93-2.32-26.56-.89-44.81,15.27-46.23,17.29-1.51,22.89,3.42,27.53,56.37,3.58,40.87-2.63,50.72-14.78,51.79ZM60.07,56.99c-11.02.96-11.62,10-10.33,24.8s4.86,23.8,14.51,22.96c9.65-.84,12.9-8.41,11.43-25.22s-4.71-23.48-15.6-22.53Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[60ms] sm:animate-delay-[60ms]")} d="M126.27,122.19c-1.12-4.14-5.47-26.46-7.35-26.3-2.13.19-2.65,25.99-2.82,31.26l-15.41,1.35-18.17-106.68,8.14-.71c5.37,28.17,8.24,43.67,10.41,52.63,1.93,7.63,2.47,10.97,4.85,10.76,2.88-.25,3.75-13.38,2.76-60.74l7.64-.67c3.85,22.37,5.85,35.07,7.62,42.38,1.45,6.48,1.85,9.66,4.23,9.45,3.51-.31,4.72-8.04,5.84-57.27l6.89-.6-.75,103.92-13.9,1.22Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[90ms] sm:animate-delay-[90ms]")} d="M170.54,124.25l-2.71-30.94c11.35-1.5,13.74-7.46,12.19-25.13l-5.34-61.03,9.02-.79,4.56,52.12c4.68,53.48,3.41,63.58-17.73,65.77Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[120ms] sm:animate-delay-[120ms]")} d="M219.32,118.96c-17.79,1.56-20.43-18.53-27.9-103.95l9.14-.8c5,55.64,7.2,67.81,15.96,67.04,4.64-.41,7.55-3.2,8.05-14.76.26-5.61,0-12.87-.69-22.3-.67-9.09-1.65-20.36-3.01-35.83l7.26-.64c7.89,90.13,8.46,109.72-8.82,111.23Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[160ms] sm:animate-delay-[160ms]")} d="M235.63,6.56l9.77-.85,9.09,103.91-9.77.85-9.09-103.91Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[210ms] sm:animate-delay-[210ms]")} d="M266.48,64.69c1.6,18.33,7.06,21.58,26.86,20.01l2.18,24.89c-25.69,2.08-34.01-4.98-38.17-52.57-3.96-45.23,4.56-54.62,30.1-57.02l3.63,41.52c-22.91,2.17-26.18,5.17-24.6,23.16Z"/>
                                    <path class={anim("animate-fade-up sm:animate-fade-left animate-delay-[280ms] sm:animate-delay-[280ms]")} d="M295.4,4.05l32.2-2.82,3.04,34.8c-23.93,2.09-24.78,3.86-24.22,10.24.63,7.23,1.57,9.35,22.99,7.48l.96,10.93c-19.67,1.72-20.88,3.69-20.2,11.42s2.07,9.31,25.39,7.44l1.93,22.03-32.95,2.88-9.13-104.41Z"/>
                                    </g>
                                </g>
                            </svg>
                            ...
                            <p class={anim(`${!typingComplete ? 'opacity-0' : 'opacity-100'} w-auto absolute -bottom-8 sm:bottom-4 md:bottom-6 lg:bottom-8 right-0 text-[10px] leading-3 text-right text-black font-mono font- uppercase animate-flip-down animate-delay-500 border-[0.5px] border-black rounded-sm bg-white p-1 transition-all duration-[1000ms]`)}>"... Moo."™</p>
                        </div>
                        ...
                        <div class="relative z-50 flex w-full items-center flex-col pt-8 space-y-8 sm:space-y-4">
                            <div class="flex w-full items-center justify-end">
                                <button onClick={() => setModal('ultra_retorted_milk')} class={anim("flex flex-col w-full h-16 sm:w-1/2 rotate-[7deg] py-4 px-2 bg-white border-[0.5px] border-black rounded-lg animate-fade animate-delay-[750ms] hover:bg-zinc-100 transition-colors duration-300 cursor-pointer")}>
                                    {/* Page intro */}
                                            ...
                                            <p class="text-left text-[10px] leading-3">
                                                <Typewriter
                                                    ...
                                                    typewriter
                                                        ...
                                                        .pauseFor(350)
                                                        .typeString("<span class='text-cowjuice-bronze font-bold border-[0.5px] border-cowjuice-bronze'>Ultra-Retorted Milk™</span>.")
                            ...
                            <div class={`${!typingComplete ? 'opacity-0' : 'opacity-100'} flex flex-col items-center justify-center w-full transition-opacity duration-[100ms]`}>
                                <div class="flex p-2 rounded-full border-[0.5px] border-black bg-white animate-bounce">
                                ...
                                <p class="text-[11px] opacity-60 uppercase font-mono animate-bounce">Enter site<sup>[1]</sup></p>
                            </div>
                    ...
                    <div class={`${!typingComplete ? 'opacity-0' : 'opacity-100'} absolute -px-6 inset-0 -bottom-[800px] sm:-bottom-[768px] z-0 flex w-full md:w-2/3 lg:w-3/4 items-center justify-end overflow-hidden transition-opacity duration-[1000ms]`}>
                        ...
                        <svg class="flex fill-cowjuice-black animate-fade-up animate-delay-[500ms]" id="Layer_2" data-name="Layer 2" viewBox="0 0 235.61 243.81">
                            <g id="Layer_1-2" data-name="Layer 1">
                                <g>
                    ...
                    {/* Footnotes */}
                    <div class={`${!typingComplete ? 'opacity-0' : 'opacity-100'} flex flex-1 w-full md:w-2/3 lg:w-3/4 border-t-[0.0px] border-white pt-4 h-full flex-col items-center justify-center sm:items-start space-y-2 animate-fade animate-delay-[1050ms] transition-opacity duration-[1000ms]`}>
                        <p class="text-[10px] text-center w-full text-white font-bold font-mono uppercase leading-3"><sup>[1]</sup> This site should not be entered by anyone fearful of milk, dairy based delight, protein revolutions, lactose-freedom-derived glory, or the greatness of this land we call the United States of Milk. Proceed at your own peril."</p>
                    </div>
                </div>
            </div>
        </>
