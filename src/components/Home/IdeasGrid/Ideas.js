...
const ideas = [
    {
        ...
        "details": [
            ...
            "I proceed in two parts. I begin by explaining the attribution of ideation to prosperity. I then explore the consequences of imbalance; here, I first lay out those definitional consequences and then consider how they harm the search for ideas and prosperity.",
            {
            ...
            },
            {
                ...
                content: [
                    ...
                    {
                        "subsection": "ii. A Global Dearth of Innovation",
                        content: [
                            ...
                            "And now consider the crowding out effect of foreign imports on deficit country ideation. Innovations to supply-side – productivity gains – are simply unnecessary, as the country offsets domestic production with foreign imports. Profit-seeking entrepreneurs are for this reason dissuaded from pursuing knowledge accumulation related to improving weakly productive domestic industries offset by foreign imports. One might object on the grounds that while the deficit country will not pursue relevant knowledge, the surplus country, since it after all produces the good, will have the incentive to do so, and ideation across the world will be no worse off. This is not so. The surplus country produces the good expressly for the same reason it runs its surplus: Weak domestic consumption and high inequality mean that cheap labor facilitates inefficient output. If deficit countries lack the incentive to ideate because they simple lack industry at home, surplus countries lack the incentive by the very same reasons they maintain their current account surplus. Subdued ideation for the globe as a whole follows.",
                        ]
                    }
                ]
            },
            {
                ...
                content: [
                    "Our collective, important mission of global prosperity, reliant upon the continual difficult work of searching for new ideas is hindered by present historic trade and financial imbalances. It would, from the perspective of this end alone, behoove us to aim for a more balanced global economy. Of course, the challenge is getting there while preserving the enormous benefits globalized trade and capital continue to deliver. But to pretend that we will continue to reap those benefits unabated without good-faith efforts to address the harms similarly inflicted is to ignore present omens. If building more balanced global trade and finance is the macroeconomic challenge of our time, recognizing the interplay between imbalances and ideation-driven prosperity is surely a necessary first step."
                ]
            },
        ],
        "notes": [
    ...
    //         "At its heart, Fiscal Theory is a backing theory of money, a gold standard, if you will, without the gold. Just as, under that order, a government’s “full faith and credit” lay in its commitment to this backing – its promise was to amass gold reserves upon redemption – and so too a stable currency and price level, fiat currency is similarly backed by a promise to amass resources – surpluses by way of taxes. Frankly – and it may be Fiscal Theory’s most important upshot – surprisingly little has changed."
    //     ],
    //     "notes": [
    //         {
    //             "id": "[1]",
    ...
    //         {
    //             "id": "[2]",
    //             "text": "That ‘Federal Reserve Note’ inscription may be read in two ways. One, greenbacks <i>belong to</i> the Federal Reserve, Uncle Sam’s bank. That reading captures Fiscal Theory’s <i>statist</i> conception of money. Two, greenbacks are redeemable at Uncle Sam’s bank. Barring certain conditions, you, the private taxpaying citizen, may redeem your greenbacks for real resources <i>at</i> the central bank, just as you may redeem your checking account balance at a private bank for goods and services. To see what the central bank gives you in exchange – that is, the resources it commits to redeem – we must press on."
    //         },
    //         {
    //             "id": "[3]",
    ...
    // },
    {
        ...
        "notes": [
            {
                "id": "[1]",
                "text": " I argue these claims at length in <a href='/ideas/imbalances-and-innovation'>Imbalances & Innovation: Persistent and Artificial Imbalances Place Downward Pressure on Innovation and Global Prosperity</a>."
            },
        ]
    }
    // {
